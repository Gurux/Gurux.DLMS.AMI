...
namespace Gurux.DLMS.AMI.Messages.Rest
{
    ...
    [Example("/api/Schedule/DeleteScheduleTarget", "{\"Schedules\":[Collection of Schedule ID(s)],\"Attributes\":[Collection of Attribute ID(s)]}", "www.gurux.fi/Gurux.DLMS.AMI.Schedule")]
